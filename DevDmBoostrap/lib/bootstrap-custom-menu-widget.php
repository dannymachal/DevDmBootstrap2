...
class bootstrap_custom_menu extends WP_Widget {
    ...
    function bootstrap_custom_menu() {
        ...
        $widget_ops = array( 'classname' => 'bootstrapwidgetmenu', 'description' => __('A custom menu widget that uses the wp_bootstrap_navwalker', 'bootstrapwidgetmenu'));

        $control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'bootstrap-widget-menu');

        $this->WP_Widget( 'bootstrap-widget-menu', __('Boot Strap Menu', 'bootstrapwidgetmenu'), $widget_ops, $control_ops);
    }
    ...
    function form( $instance ) {
     ...
     $defaults = array ( 'title' => __('Menu', 'bootstrapwidgetmenu'), 'menuname' => __('', 'bootstrapwidgetmenu'), 'menutype' => 'nav-tabs');
    ...
    <p>
     ...
     <p>
            <label for="<?php echo $this->get_field_id( 'menuname' ); ?>">Menu:</label>
            <select id="<?php echo $this->get_field_id( 'menuname' ); ?>" name="<?php echo $this->get_field_name( 'menuname' ); ?>" style="width:100%;" type="text">
                <?php
                    ...
                    $menus = get_terms( 'nav_menu', array( 'hide_empty' => false ) );
                        ...
                        echo "<option value=''>Default All Pages</option>";
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'menutype' ); ?>">Menu Type:</label>
