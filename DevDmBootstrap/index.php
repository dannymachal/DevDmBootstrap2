                    ...
                    // list of posts
                       ...
                       <div <?php post_class(); ?>>
                            ...
                            <?php  if ( comments_open() ) : ?>
                                   <div class="clear"></div>
                                  <p class="text-right">
                                      <a class="btn btn-success" type="button" href="<?php the_permalink(); ?>#comments"><?php comments_number('Leave a Comment', 'One Comment', '% Comments' );?> <i class="icon-comment icon-white"></i></a>
                                  </p>
                            <?php endif; ?>
                       </div>
